...
<div class="section no-pad-bot" id="index-banner">
    <form class="container" action="/persons/user-info" method="post">
        <input name="id" type="number" hidden value="${getLoginUser().id}">
        <br><br>
        <div class="row">
            <div class="col s12">
                <div class="col s12 m4">
                    <div class="card">
                        <div class="card-title green lighten-1" style="padding: 10px 10px 0px 10px">
                            <div class="row valign-wrapper">
                                <div class="col s3 m4 l2">
                                    <img src="/assets/img/favicon.png" alt="" class="circle responsive-img">
